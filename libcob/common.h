...
#define COB_LOCK_ROLLBACK	(1U << 5) //kamal079 - mf merge file changes
...
//kamal079 - mf merge file changes (begin)
/* Sharing option */
...
#define COB_READ_ADVANCING_LOCK	(1 << 9) //kamal079 - merge mf file changes
...
typedef struct __cob_io_stat_s {
