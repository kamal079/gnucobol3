...
static struct config_enum varseqopts[] = {{"0", "0"}, {"1", "1"}, {"2", "2"}, {"3", "3"}, {"mf","11"},{"gc","10"},{"b4","4"},{"b32","4"},{"l4","6"},{"l32","6"},{NULL, NULL}};
...
static struct config_tbl gc_conf[] = {
	...
	{"COB_FIXREL_FORMAT","fixrel_format",	fixrel_dflt,relopts,GRP_FILE,ENV_INT | ENV_ENUM,SETPOS(cob_fixrel_type)}, /*kamal079 - mf file merge changes */
	{"COB_VARREL_FORMAT","varrel_format",	varrel_dflt,relopts,GRP_FILE,ENV_INT | ENV_ENUM,SETPOS(cob_varrel_type)}, /*kamal079 - mf file merge changes */
